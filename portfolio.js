...
export const skillsSection = {
  ...
  skills: [
    ...
    "⚡ Develop backend authentcation and RESTful API",
    "⚡ Develop web applications from scratch",
    "⚡ Implement test driven development",
	"⚡ Create ecommerce applications with latest Javascript technologies"
  ],
...
export const experience = [
  {
    ...
    descBullets: [
      ...
      "Working on the backend to develop validators and authentication",
...
export const projects = [
  ...
  {
    name: "File Decryptor",
    desc: "Taking inputs from files in binary format and then converting it to strings with C using Linked lists. Using the chi-square formula, the program decodes the encrypted string.",
